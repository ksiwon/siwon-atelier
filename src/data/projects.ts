...
export const projects: Project[] = [
  // AEL
  { id: 'osler', title: 'Osler', description: 'Surgery Consent Support Agent (w. Asan Medical Center)', category: 'AEL', link: 'https://osler.siwon.site', tech: ['AI', 'Healthcare', 'NLP'], featured: true, star: true, color: '#6366f1' },
  { id: 'freud-jr', title: 'Freud-Jr', description: 'Psychiatry First-visit Support Platform (w. Yonsei Severance)', category: 'AEL', link: 'https://freud-jr.siwon.site', tech: ['AI', 'Mental Health', 'UX'], featured: true, star: true, color: '#8b5cf6' },
  { id: 'medicall', title: 'MediCall', description: 'AI Medical Tourism Platform (at. SWITCH SG)', category: 'AEL', link: 'https://medicall.siwon.site', tech: ['AI', 'Tourism', 'Healthcare'], featured: true, color: '#06b6d4' },
  { id: 'choreobot', title: 'ChoreoBot', description: 'Choreography Creation Support Chatbot', category: 'AEL', link: 'https://choreobot.siwon.site', tech: ['AI', 'Dance', 'Generative'], color: '#ec4899' },
  ...
  { id: 'stl', title: 'STL', description: 'AI-based Timetable Generator', category: 'Own', link: 'https://stl.siwon.site', tech: ['AI', 'Optimization', 'KAIST'], featured: true, star: true, color: '#3b82f6' },
  { id: 'votex', title: 'VoteX', description: 'Online Secret Voting Platform', category: 'Own', link: 'https://votex.siwon.site', tech: ['Security', 'Web3', 'Democracy'], color: '#22c55e' },
  { id: 'pawmo', title: 'Pawmo', description: 'KAIST Graduation Checker', category: 'Own', link: 'https://pawmo.siwon.site', tech: ['KAIST', 'Graduation', 'Checker'], color: '#22c55e' },
  { id: 'missvoice', title: 'MissVoice', description: 'Recording-based AI Voice Generator', category: 'Own', link: 'https://missvoice.siwon.site', tech: ['AI', 'Voice', 'TTS'], color: '#f43f5e' },
  ...
  { id: 'kbo-scouter', title: "I'm KBO Scouter!", description: 'Data-driven KBO Foreign Hitter Scouter', category: 'Own', link: 'https://im-kbo-scouter.siwon.site', tech: ['Data', 'Sports', 'Analytics'], star: false, color: '#ef4444' },
  ...
  { id: 'reviewtrust', title: 'ReviewTrust', description: 'Product Review Comparison Platform', category: 'Own', link: 'https://reviewtrust.siwon.site', tech: ['E-commerce', 'NLP', 'Analysis'], color: '#84cc16' },
